...
class _AttendanceIndexPageDayState extends State<AttendanceIndexPageDay> {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<AttendanceIndexModel>(
      create: (_) => AttendanceIndexModel()..fetchAttendance(),
      child:  Scaffold(
        body: SingleChildScrollView(
          child: Column(
            children: [
              Consumer<AttendanceIndexModel>(builder: (context, model, child) {
                return SizedBox(
                  height: 1100,
                  child: SfCalendar(
                    dataSource: AttendanceDataSource(model.attendances),
